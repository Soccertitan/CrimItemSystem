...
void FCrimItemGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Crim_ItemPlan_Error_ItemAlreadyExists = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Crim.ItemPlan.Error.ItemAlreadyExists"), FString("The item already exists in the container."));
	...
	GameplayTags.Crim_ItemPlan_Error_ItemContainerIsChild = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Crim.ItemPlan.Error.ItemContainerIsChild"), FString("Child containers can't have new items added to them. Only existing items."));
